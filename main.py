...
def main():
    video_feed_provider = VideoFeedProvider(Path("/home/anmol/Downloads/normal_car.jpg"))
    ...
    license_plate_detector_2 = LicensePlateDetectorYolo(coco_model, license_plate_detector)

    while video_feed_provider.has_next_frame():
        frame = video_feed_provider.get_frame()

        license_numbers = license_plate_detector.get_licence_place_numbers(frame)
