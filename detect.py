...
class LicensePlateDetectorOpenCvGeeksForGeeks(LicensePlateDetector):
    ...
    def get_licence_place_numbers(self, input_img):
        ...
        cv2.imwrite("/home/anmol/development/misc/military-vehicle-number-plate-detection/dump/after_preprocess.png", self.after_preprocess)
